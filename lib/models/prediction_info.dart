...
/// target temperature and other cooking predictions. Predictions are only available after a target temperature has been
/// set using `DeviceManager.setTargetTemperature`.
@immutable
class PredictionInfo {
  ...
  ///
  /// Predictions may be unreliable during the initial cooking phase when temperature trends are not yet established, or
  /// if the probe is experiencing connectivity issues.
  ...
  factory PredictionInfo.fromMap(Map<String, dynamic> map) {
    ...
    return PredictionInfo(
      ...
      targetTemperatureCelsius: (map['targetTemperatureCelsius'] as num?)?.toDouble(),
      currentCoreTempCelsius: (map['currentCoreTempCelsius'] as num?)?.toDouble(),
