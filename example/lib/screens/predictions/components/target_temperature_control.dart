...
///
/// This widget provides a keypad interface for entering custom temperatures, discrete preset buttons, and transforms
/// into a prediction display once a target temperature is set.
///
/// The control respects the user's temperature unit preference and validates input to ensure reasonable cooking
/// temperatures.
class TargetTemperatureControl extends StatefulWidget {
  /// Callback function called when a target temperature is set. The temperature is provided in Celsius regardless of
  /// display unit.
