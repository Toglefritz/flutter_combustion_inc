...
///
/// This widget shows a collection of common cooking temperatures organized as selectable chips for quick temperature
/// selection.
class TemperaturePresetsWidget extends StatelessWidget {
  ...
  ///
  /// The presets are displayed as action chips that trigger [onPresetSelected] when tapped. The temperature values are
  /// automatically converted to the current temperature unit setting.
