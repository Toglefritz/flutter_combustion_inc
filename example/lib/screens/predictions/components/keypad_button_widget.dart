...
///
/// This widget represents a single button in the keypad interface, handling both numeric input and special characters
/// like backspace.
class KeypadButtonWidget extends StatelessWidget {
  ...
  ///
  /// The button displays the [value] and calls [onPressed] when tapped. The [flex] parameter controls the button's
  /// width relative to other buttons.
