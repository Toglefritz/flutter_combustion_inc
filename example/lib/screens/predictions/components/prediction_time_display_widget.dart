...
///
/// This widget shows the estimated time remaining until the target temperature is reached, with different states for
/// loading, calculating, and completion.
class PredictionTimeDisplayWidget extends StatelessWidget {
  ...
  ///
  /// If [predictionInfo] is null, shows a placeholder message. Otherwise displays the appropriate time estimate or
  /// status message.
