...
///
/// A [LegendItem] contains the visual information needed to display a legend entry, including the color and label text
/// that corresponds to a specific temperature line in the chart.
class LegendItem {
