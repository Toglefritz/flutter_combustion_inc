...
class RealTimeTemperatureChart extends StatelessWidget {
  ...
  ///
  /// For real-time data, this ensures the chart always shows a maximum of 30 seconds of data by calculating the minimum
  /// X value based on the maximum X value.
  double _getMinX(List<LineChartBarData> lineBarsData) {
    ...
    // Use the larger of the calculated minimum or the actual minimum data point This ensures we don't show empty space
    // when there's less than 30 seconds of data
