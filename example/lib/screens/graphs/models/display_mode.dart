...
///
/// Combustion Inc. temperature probes deliver a variety of data, including temperature readings represented in multiple
/// different ways and historical temperature data. This enum is used to specify which data should be displayed and how
/// it should be formatted in the user interface.
enum DisplayMode {
