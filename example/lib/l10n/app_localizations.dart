...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to: **'Settings'**
  String get settings;

  /// Label for temperature unit setting.
  ///
  /// In en, this message translates to: **'Temperature Unit'**
  String get temperatureUnit;

  /// Label for Celsius temperature unit option.
  ///
  /// In en, this message translates to: **'Celsius (°C)'**
  String get celsius;

  /// Label for Fahrenheit temperature unit option.
  ///
  /// In en, this message translates to: **'Fahrenheit (°F)'**
  ...
  /// Banner message shown when the selected probe loses its BLE connection.
  ///
  /// In en, this message translates to: **'Probe disconnected'**
  String get probeDisconnected;

  /// Banner message shown while the app is attempting to re-establish a lost BLE connection.
  ///
  /// In en, this message translates to: **'Reconnecting to probe...'**
